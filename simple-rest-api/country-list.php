...
$country_dataset= array(
    ...
    array("name"=>"Bolivia, Plurinational State of","code"=>"BO"),
    ...
    array("name"=>"Congo, the Democratic Republic of the","code"=>"CD"),
    ...
    array("name"=>"Palestine, State of","code"=>"PS"),
    ...
    array("name"=>"Réunion","code"=>"RE"),
    array("name"=>"Romania","code"=>"RO"),
    array("name"=>"Russian Federation","code"=>"RU"),
    array("name"=>"Rwanda","code"=>"RW"),
    array("name"=>"Saint Barthélemy","code"=>"BL"),
    array("name"=>"Saint Helena, Ascension and Tristan da Cunha","code"=>"SH"),
    array("name"=>"Saint Kitts and Nevis","code"=>"KN"),
    array("name"=>"Saint Lucia","code"=>"LC"),
    array("name"=>"Saint Martin (French part),","code"=>"MF"),
    ...
    array("name"=>"Sint Maarten (Dutch part),","code"=>"SX"),
    ...
    array("name"=>"Venezuela, Bolivarian Republic of","code"=>"VE"),
